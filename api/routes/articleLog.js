...
router.get('/single/:id', (req, res) => { Controller.getSingleArticle(req, res, ArticleLog) });
...
router.patch('/removeimage', Authenticate, (req, res) => { Controller.removeImage(req, res, ArticleLog) })
